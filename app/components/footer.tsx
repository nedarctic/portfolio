                    ...
                    <div className='flex-col space-y-4'>
                        <Link href="https://wa.me/+254797517270" target='_blank' rel='noopener noreferrer' className="block">
                            <div className='flex items-center flex-row space-x-3'>
                                ...
                                <p className={`${spaceMono.className} text-black font-normal text-sm lg:text-lg md:text-md space-x-5`}>+254797517270</p>
                            </div>
                        </Link>
                        <Link href="mailto:justkimtai@gmail.com" target="_blank" rel="noopener noreferrer" className='block'>
                            <div className='flex items-center flex-row space-x-3'>
                                ...
                                <p className={`${spaceMono.className} text-black font-normal italic text-sm lg:text-lg md:text-md space-x-5`}>justkimtai@gmail.com</p>
                            </div>
                        </Link>
                    </div>
                    <div className='flex-col space-y-4'>
                        <Link href="https://facebook.com/justkimtai" target="_blank" rel="noopener noreferrer" className='block'>
                            <div className='flex items-center flex-row space-x-3'>
                                ...
                                <p className={`${spaceMono.className} text-black font-normal italic text-sm lg:text-lg md:text-md space-x-5`}>Justus Kimtai</p>
                            </div>
                        </Link>
