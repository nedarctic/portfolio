...
export default function ContactPage() {
    return (
        <div className='flex flex-col justify-center items-center space-y-10'>
            <p className={`${bodoniModa.className} ${styles.scrollanimate} font-black italic px-4 text-6xl`}>Contact</p>
            <div className="flex flex-col py-10 px-4 items-center sm:flex-row sm:space-x-10 justify-center space-y-10 sm:space-y-0">
                <p className='{`${bodoniModa.className} ${styles.scrollanimate} self-start italic px-4 text-sm`}'>If you&apos;re looking for:
